    ...
    <aside className="bg-white w-64 min-h-screen p-4 border-r border-gray-200">
      ...
      <nav>
        <ul className="space-y-2">
          <li>
            <Link to="/dashboard" className={`sidebar-link ${isActive('/dashboard') ? 'bg-blue-100 text-blue-600' : ''}`}>
          ...
          <li>
            ...
            {onboardingOpen && (
              <ul className="pl-6 mt-2 space-y-1">
                <li>
                  <Link to="/onboarding/tasks" className={`sidebar-link ${isActive('/onboarding/tasks') ? 'bg-blue-50 text-blue-600' : ''}`}>
                    <HiClipboardList className="sidebar-icon" />
                    <span>Tasks</span>
                  </Link>
                </li>
                <li>
                  <Link to="/onboarding/workflow" className={`sidebar-link ${isActive('/onboarding/workflow') ? 'bg-blue-50 text-blue-600' : ''}`}>
          ...
          <li>
            <Link to="/project" className={`sidebar-link ${isActive('/project') ? 'bg-blue-100 text-blue-600' : ''}`}>
              <HiViewGrid className="sidebar-icon" />
              <span>Project</span>
            </Link>
          </li>
          <li>
            <Link to="/volunteers" className={`sidebar-link ${isActive('/volunteers') ? 'bg-blue-100 text-blue-600' : ''}`}>
